...
#			logger.superverbose("Got Icon!!!")
		...
		var server_text : String = (tr("server_list_format").format({"server_name": json.name, "server_motd": json.motd})) + "    " + tr("player_count_format").format({"number_players": json.num_players, "max_players": json.max_players})
